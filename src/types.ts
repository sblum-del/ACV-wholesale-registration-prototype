...
export type ActiveScenario = 's1' | 's1b' | 's2' | 's3' | 's4' | 's5' | 's6' | 's7' | 's8' | 's8b' | 's9' | 's10' | 's11' | 'r1' | 'r2' | 'r3' | 'r4' | 'r5' | 'r6' | 'r6n' | 'v2-base' | 'v2-15pct' | 'v2-5pct' | 'v2-banking-no-accounts' | 'v2-banking-mixed' | 'v2-banking-single-closed'
