...
export function InProgressOtherUser({ setView, applicationCancelled, isExistingUser }: Props) {
  // r6 = existing user (has another registered dealership, signs in)
  // r6n = net-new user (no prior ACV account, creates credentials)
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-6 pt-10 pb-16">
        ...
        {/* ── IN PROGRESS 1 (existing user) ── */}
        {isExistingUser && (
          <>
            {/* Section 1: Registered/Joined — shown first, greyed, no action */}
            {!applicationCancelled && (
              <>
